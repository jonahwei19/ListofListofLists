...
## Why it matters
AI governance decisions made by small groups of experts may lack democratic legitimacy and miss important perspectives. Citizen assemblies can produce well-informed public judgment that has broader acceptance and may identify considerations experts overlook.

## Current state
- **Status**: Pilot
- **Who's working on it**: Not specified (citizen assembly methodology exists but not widely applied to AI/GCR)
