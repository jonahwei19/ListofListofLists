...
**Source**: Peregrine 2025, Proposal #35
...
## Why it matters
Safety researchers outside major labs lack compute access, limiting what they can study. If access depends on lab cooperation, it can be revoked. Independent compute infrastructure ensures safety research can continue regardless of lab decisions, while governance mechanisms prevent the infrastructure from being used to advance dangerous capabilities.
