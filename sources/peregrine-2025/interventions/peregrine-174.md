...
**Source**: Peregrine 2025, Proposal #174
...
## Why it matters
Hardware and low-level infrastructure vulnerabilities can undermine all higher-level safety measures. Formal verification at the hardware level provides foundational guarantees that can't be circumvented by software exploits.
