...
**Source**: Peregrine 2025, Proposal #114
...
## Why it matters
Democratic institutions are the foundation for legitimate AI governance. If these institutions are weakened, the ability to establish and enforce AI safety regulations diminishes. AI could also accelerate democratic erosion through disinformation and manipulation.

## Current state
- **Status**: Pilot
- **Who's working on it**: Effektiv Spenden (Germany), various democracy-strengthening organizations
