...
2023 Nov 27[See all posts](https://vitalik.eth.limo/index.html)  
...
|   |   |   |
|---|---|---|
|![](https://vitalik.eth.limo/images/techno_optimism/path1.png)|![](https://vitalik.eth.limo/images/techno_optimism/path2.png)|![](https://vitalik.eth.limo/images/techno_optimism/path3.png)|
...
[![](https://vitalik.eth.limo/images/techno_optimism/life_expectancy.png)](https://ourworldindata.org/grapher/life-expectancy?time=1900..latest&country=JPN~FRA~CHN~USA~ARG~IND~DEU~RUS~OWID_AFR)
...
![](https://vitalik.eth.limo/images/techno_optimism/medbook.png)
...
[![](https://vitalik.eth.limo/images/techno_optimism/temperature.png)](https://digg.com/2020/global-mean-temperature-past-2000-years)
...
[![](https://vitalik.eth.limo/images/techno_optimism/smog.png)](https://www.britannica.com/event/Great-Smog-of-London)
...
[![](https://vitalik.eth.limo/images/techno_optimism/pollution.png)](https://ourworldindata.org/london-air-pollution)
...
![](https://vitalik.eth.limo/images/techno_optimism/techtrajectory.png)
...
![dacc3](https://vitalik.eth.limo/images/techno_optimism/dacc.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/switzerland.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/differential.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/defensetypes.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/0chan.png)
...
[Zupass](https://zupass.org/), incubated at [Zuzalu](https://www.palladiummag.com/2023/10/06/why-i-built-zuzalu) earlier this year, is an excellent example of this in practice. This is an application, which has already been used by hundreds of people at Zuzalu and more recently by thousands of people for ticketing at [Devconnect](https://devconnect.org/), that allows you to hold tickets, memberships, ([non-transferable](https://vitalik.eth.limo/general/2022/01/26/soulbound.html)) digital collectibles, and other attestations, and prove things about them all without compromising your privacy. For example, you can prove that you are a unique registered resident of Zuzalu, or a Devconnect ticket holder, _without revealing anything else about who you are_. These proofs can be shown in-person, via a QR code, or digitally, to log in to applications like [Zupoll](https://zupoll.org/), an anonymized voting system available only to Zuzalu residents.
...
Take, for example, fact checking (aka, preventing "misinformation"). I am a [huge fan of Community Notes](https://vitalik.eth.limo/general/2023/08/16/communitynotes.html), which has done a lot to help users identify truths and falsehoods in what other users are tweeting. Community Notes uses a new algorithm which surfaces not the notes that are the _most popular_, but rather the notes that are _most approved by users across the political spectrum_.

  

![](https://vitalik.eth.limo/images/techno_optimism/helpfulnote2.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/samback.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/scamblock.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/viewpoints.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/carbonvote.png)
...
|   |   |
|---|---|
|![](https://vitalik.eth.limo/images/techno_optimism/poll1.png)|![](https://vitalik.eth.limo/images/techno_optimism/poll2.png)|
|![](https://vitalik.eth.limo/images/techno_optimism/poll3.png)|
...
![](https://vitalik.eth.limo/images/techno_optimism/genfill.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/mindpaths.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/civprogress.png)
...
![](https://vitalik.eth.limo/images/techno_optimism/dacc_2.png)
